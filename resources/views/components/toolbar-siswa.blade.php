<div class="d-flex justify-content-between mb-3" role="toolbar">
    <div class="btn-group">
        ...
        <a href="{{ route('siswa.import') }}" class="btn btn-de-info "><i class="fas fa-file-excel"></i> Import
            Siswa
        </a>
    </div>
    <div class="btn-group ms-1">
        ...
        <form action="{{ route('siswa.cari') }}" method="GET" class="input-group ms-3">
            <input type="text" class="form-control" placeholder="Cari Nama Siswa" aria-label="Recipient's username"
                   aria-describedby="button-addon2" name="cari" value="{{ request()->cari }}">
            <button type="submit" class="btn btn-de-secondary" type="button" id="button-addon2">Cari</button>
        </form>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group mb-2">
                                    <label for="confirpassword" class="form-label">Confirm Password <i
                                            class="fa fa-info-circle text-info"></i></label>
